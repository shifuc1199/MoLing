...
public class Enemy_7_Magic_PartolState : StateTemplate<Enemy_7_Magic_Controller>
{

    int index = 0;

    public Enemy_7_Magic_PartolState(string id, Enemy_7_Magic_Controller p) : base(id, p)
    {
